...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.tsel.mepro.quotedetails.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.tsel.mepro.quotedetails.security.DomainUserDetailsService", "createSpringSecurityUser");
    }
}
