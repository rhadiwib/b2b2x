...
public class Project implements Serializable {
    ...
    public void setCpqQuotedetails(CpqQuotedetails cpqQuotedetails) {
        if (this.cpqQuotedetails != null) {
            this.cpqQuotedetails.setProject(null);
        }
        if (cpqQuotedetails != null) {
            cpqQuotedetails.setProject(this);
        }
        this.cpqQuotedetails = cpqQuotedetails;
    }

    public Project cpqQuotedetails(CpqQuotedetails cpqQuotedetails) {
