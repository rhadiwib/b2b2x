...
public class CpqQuotedetails implements Serializable {
    ...
    public CpqQuotedetails addBundle(Bundle bundle) {
        this.bundles.add(bundle);
        bundle.setCpqQuotedetails(this);
        return this;
    }

    public CpqQuotedetails removeBundle(Bundle bundle) {
    ...
    public CpqQuotedetails addVersion(Version version) {
        this.versions.add(version);
        version.setCpqQuotedetails(this);
        return this;
    }

    public CpqQuotedetails removeVersion(Version version) {
