...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './bundle.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BUNDLE_LIST actions', async () => {
    ...
    it('dispatches FETCH_BUNDLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_BUNDLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_BUNDLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_BUNDLE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_BUNDLE actions', async () => {
      const expectedActions = [
        {
