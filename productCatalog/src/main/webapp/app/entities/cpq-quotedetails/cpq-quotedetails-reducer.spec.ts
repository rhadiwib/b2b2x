...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CPQQUOTEDETAILS_LIST actions', async () => {
    ...
    it('dispatches FETCH_CPQQUOTEDETAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CPQQUOTEDETAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CPQQUOTEDETAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CPQQUOTEDETAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CPQQUOTEDETAILS actions', async () => {
      const expectedActions = [
        {
