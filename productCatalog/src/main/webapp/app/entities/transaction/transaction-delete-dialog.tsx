...
export const TransactionDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="productCatalogApp.transaction.delete.question">
        <Translate contentKey="productCatalogApp.transaction.delete.question" interpolate={{ id: transactionEntity.id }}>
